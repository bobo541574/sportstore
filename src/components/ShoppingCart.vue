            ...
            <div class="col mt-2">
                ...
                <table class="table table-bordered table-striped p-2">
                    ...
                    <tbody>
                        ...
                        <ShoppingCartLine v-for="line in lines" :key="line.product.id" :line="line" @quantity="handleQuantityChange(line, $event)" @remove="remove" />
                    </tbody>
        ...
        <div class="row">
            <div class="col">
                <div class="text-center">
                    ...
                    <router-link to="/checkout" class="btn btn-primary m-1" :disabled="lines.length == 0">
                        Checkout
                    </router-link>
                </div>
            </div>
